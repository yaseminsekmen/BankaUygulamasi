...
namespace BankaUygulamasi
{
    public partial class Form7 : Form
    {
        ...
        {
            Listele("select*from KrediKarti");
            baglanti.Open();
            SqlCommand komut = new SqlCommand("select kk_id from KrediKarti", baglanti);
            SqlDataReader dr;
            dr = komut.ExecuteReader();
            while (dr.Read())
            {
                comboBox1.Items.Add(dr["kk_id"]);
            }
            baglanti.Close();
            baglanti.Open();
        ...
        {
            baglanti.Open();
            SqlCommand komut = new SqlCommand("insert into KrediKarti(hesap_id,Tipi,Numara)values(@hesap_id,@Tipi,@Numara)", baglanti);
            ...
            baglanti.Open();
            SqlCommand komut1 = new SqlCommand("select kk_id from KrediKarti", baglanti);
            SqlDataReader dr;
        ...
        {
            baglanti.Open();
            SqlCommand komut = new SqlCommand("delete from KrediKarti where kk_id=@kk_id", baglanti);
            komut.Parameters.AddWithValue("@kk_id", comboBox1.SelectedItem.ToString());
            komut.ExecuteNonQuery();
            baglanti.Close();
            Listele("select*from KrediKarti");
        ...
        private void button4_Click(object sender, EventArgs e)
        {
            ...
            SqlCommand komut = new SqlCommand("select*from KrediKarti where kk_id like '%" + comboBox1.SelectedItem.ToString() + "%'", baglanti);
        ...
        {
            baglanti.Open();
            SqlCommand komut = new SqlCommand("Update KrediKarti set hesap_id='" + comboBox2.SelectedItem.ToString() + "',Tipi='" + comboBox3.SelectedItem.ToString() + "',Numara='" + textBox1.Text.ToString() + "'where kk_id='" + comboBox1.SelectedItem.ToString() + "'", baglanti);
            komut.ExecuteNonQuery();
            baglanti.Close();
            Listele("select*from KrediKarti");
        }
